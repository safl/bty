/* bty-server's iPXE feature trims.
 *
 * Copied into iPXE's ``src/config/local/general.h`` at build
 * time by ``cijoe/scripts/bty_ipxe_build.py``. iPXE's build
 ...
 *   2. ``chain http://...`` to bty-web's pxe-bootstrap.ipxe.
 *
...
/* Drop wireless entirely -- bty targets are wired. */
#undef NET80211
